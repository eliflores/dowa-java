...
import com.uabc.dowa.jdbc.connection.ConnectionFactory; // this give to hus the connection.
import com.uabc.dowa.jdbc.model.Student; //our model.
...
public class StudentRepository {
    public void persistStudent(Student student) throws SQLException {
        //we can see the benefist of our connectionFactory.
    ...
    public Student findStudentByFirstName(String firstName) throws SQLException{
        ...
        try {
            pstmt = conn.prepareStatement("SELECT * FROM student WHERE first_name = '" + firstName + "'");
            rs = pstmt.executeQuery();
            if(rs.next()) {
    ...
    public void deleteStudent(Student student) throws SQLException{
        ...
        try {
            pstmt = conn.prepareStatement("DELETE FROM student WHERE first_name = '"+student.getFirstName()+
